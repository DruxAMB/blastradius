...
import { FadeUp, useScrollProgress } from "@/components/animations";
import BlastApp from "@/components/blast-app";
...
export default function LandingPage() {
  ...
  const transitionToApp = () => {
    ...
    // Fade out landing content, then show app
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Fixed particle constellation — behind everything in both views */}
        ...
        <div ref={landingRef}>
          ...
          <nav className="fixed top-0 left-0 right-0 z-50 px-8 py-6">
            <div className="max-w-[1280px] mx-auto flex items-center justify-between">
              ...
              <div className="flex items-center gap-10">
                ...
                <button onClick={transitionToApp} className="btn-violet flex items-center gap-1">
              ...
              <div className="max-w-xl">
                ...
                <FadeUp delay={0.3}>
                  <div className="flex items-center gap-6">
                    <button onClick={transitionToApp} className="btn-violet">
          ...
          <section className="relative z-10 px-8 py-[120px]">
            <div className="max-w-[1280px] mx-auto">
              ...
              <div className="space-y-[80px]">
                <RiskLayer number="01" label="BLAST RADIUS" title="Transitive reverse dependency closure" description="Every package affected, directly or indirectly, up to 10 hops. Computed via HydraDB's native OpenCypher path procedure — a graph traversal, not a search." color="#8052ff" reversed />
                <RiskLayer number="02" label="SHARED MAINTAINERS" title="If a maintainer is compromised" description="Every package they maintain is at risk. Traced through the maintainer graph: package → MAINTAINED_BY → maintainer ← MAINTAINED_BY ← other packages." color="#ffb829" />
                <RiskLayer number="03" label="TYPOSQUAT DETECTION" title="Packages with similar names" description="Potential typosquat attacks, ranked by Levenshtein edit distance. Catches left_pad, leftpad, lodas — the packages that trick developers into installing malware." color="#15846e" reversed />
              </div>
            </div>
          </section>
          ...
          <section className="relative z-10 px-8 py-[160px]">
            <FadeUp className="max-w-[1280px] mx-auto text-center">
              ...
              <button onClick={transitionToApp} className="btn-violet inline-block">
                Launch BlastRadius
              </button>
            </FadeUp>
          </section>
      ...
      {/* App view — same page, animated in */}
      {view === "app" && (
        <div ref={appRef}>
          <BlastApp onBack={transitionToLanding} />
        </div>
      )}
    </div>
  );
